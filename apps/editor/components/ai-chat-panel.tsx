...
const OPERATION_LABEL_KEYS = {
  ...
  offsetBodyFace: 'aiChat.op.offsetBodyFace',
  sweepBodyFace: 'aiChat.op.sweepBodyFace',
  imprintBodyFace: 'aiChat.op.imprintBodyFace',
  splitBodyFace: 'aiChat.op.splitBodyFace',
  transformBody: 'aiChat.op.transformBody',
  arrayBodyLinear: 'aiChat.op.arrayBodyLinear',
  arrayBodyCircular: 'aiChat.op.arrayBodyCircular',
  unionBodies: 'aiChat.op.unionBodies',
  subtractBodies: 'aiChat.op.subtractBodies',
  intersectBodies: 'aiChat.op.intersectBodies',
  outerShellBodies: 'aiChat.op.outerShellBodies',
  trimBodies: 'aiChat.op.trimBodies',
  splitBodies: 'aiChat.op.splitBodies',
  groupBodies: 'aiChat.op.groupBodies',
  createComponent: 'aiChat.op.createComponent',
  makeComponentUnique: 'aiChat.op.makeComponentUnique',
  explodeComponent: 'aiChat.op.explodeComponent',
