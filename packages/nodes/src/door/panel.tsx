...
const doorTypeOptions = (t: (key: MessageId) => string) =>
  [
    { label: t('panel.hinged'), value: 'hinged', available: true },
    { label: t('panel.double'), value: 'double', available: true },
    { label: t('panel.french'), value: 'french', available: true },
    { label: t('panel.folding'), value: 'folding', available: true },
    { label: t('panel.pocket'), value: 'pocket', available: true },
    { label: t('panel.barn'), value: 'barn', available: true },
    { label: t('panel.sliding'), value: 'sliding', available: true },
  ] satisfies {
    label: string
...
const garageDoorTypeOptions = (t: (key: MessageId) => string) =>
  [
    { label: t('panel.sectional'), value: 'garage-sectional', available: true },
    { label: t('panel.rollUp'), value: 'garage-rollup', available: true },
    { label: t('panel.tiltUp'), value: 'garage-tiltup', available: true },
  ] satisfies {
    label: string
    value: DoorNode['doorType']
    available: boolean
...
export default function DoorPanel() {
  ...
  return (
    <PanelWrapper
      ...
      width={320}
    >
      <PanelSection title={t('panel.type')}>
        <div className="flex flex-col gap-2 px-1 pb-1">
          <SegmentedControl
            ...
            options={[
              { label: t('panel.door'), value: 'door' },
              { label: t('panel.opening'), value: 'opening' },
              { label: t('panel.garage'), value: 'garage' },
            ]}
            value={typeMode}
          />
        </div>
      ...
      <PanelSection title={t('panel.documentation')}>
      ...
      {showFoldSection && (
        <PanelSection title={t('panel.fold')}>
          <div className="flex flex-col gap-2 px-1 pb-1">
      ...
      {showSlideSection && (
        <PanelSection title={t('panel.slide')}>
          <div className="flex flex-col gap-2 px-1 pb-1">
            <div className="space-y-1">
              <span className="font-medium text-[10px] text-muted-foreground/80 uppercase tracking-wider">
              ...
              <SegmentedControl
                ...
                options={[
                  { label: t('panel.left'), value: 'left' },
                  { label: t('panel.right'), value: 'right' },
                ]}
      ...
      {showGarageSection && (
        <PanelSection title={t('panel.garage')}>
          <SliderControl
            label={t('panel.open')}
            max={100}
            min={0}
      ...
      {showDoorShapeSection && (
        <PanelSection title={t('panel.topShape')}>
          <div className="flex flex-col gap-2 px-1 pb-1">
            <SegmentedControl
              onChange={(v) =>
                handleUpdate({
              ...
              options={[
                { label: t('panel.rect'), value: 'rectangle' },
                { label: t('panel.rounded'), value: 'rounded' },
                { label: t('panel.arch'), value: 'arch' },
              ]}
              value={doorShape}
            />
          </div>
            ...
            <>
              <div className="flex flex-col gap-2 px-1 pb-1">
                <SegmentedControl
                  ...
                  options={[
                    { label: t('panel.all'), value: 'all' },
                    { label: t('panel.individual'), value: 'individual' },
                  ]}
      ...
      {showOpeningShapeSection && (
        <PanelSection title={t('panel.openingShape')}>
          <div className="flex flex-col gap-2 px-1 pb-1">
            <SegmentedControl
              onChange={(v) =>
                handleUpdate({
      ...
      {!isCutoutOnly && (
        <>
          {showFrameSection && (
            <PanelSection title={t('panel.frame')}>
              <SliderControl
          ...
          {showContentPaddingSection && (
            <PanelSection title={t('panel.contentPadding')}>
              <SliderControl
                label={t('panel.horizontal')}
                max={0.2}
                min={0}
          ...
          {showSwingSection && (
            <PanelSection title={t('panel.swing')}>
              <div className="flex flex-col gap-2 px-1 pb-1">
                {supportsHingeSide && (
                  <div className="space-y-1">
                    <span className="font-medium text-[10px] text-muted-foreground/80 uppercase tracking-wider">
                ...
                <div className="space-y-1">
                  ...
                  <SegmentedControl
                    ...
                    options={[
                      { label: t('panel.inward'), value: 'inward' },
                      { label: t('panel.outward'), value: 'outward' },
                    ]}
          ...
          {showThresholdSection && (
            <PanelSection title={t('panel.threshold')}>
              <ToggleControl
                checked={node.threshold}
                label={t('panel.enableThreshold')}
          ...
          {showHandleSection && (
            <PanelSection title={t('panel.handle')}>
              {isSwingDoor && (
                <ToggleControl
                  checked={node.handle}
                  label={t('panel.enableHandle')}
                ...
                return (
                  <div className="mb-2 flex flex-col gap-1" key={i}>
                    ...
                    <SegmentedControl
                      ...
                      options={[
                        { label: t('panel.panel'), value: 'panel' },
                        { label: t('panel.glass'), value: 'glass' },
                        { label: t('panel.empty'), value: 'empty' },
                      ]}
                      value={seg.type}
                    />
