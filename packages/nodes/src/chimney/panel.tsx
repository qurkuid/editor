...
const CHIMNEY_TYPE_OPTIONS = (
  t: (key: MessageId) => string,
): Array<{ label: string; value: ChimneyType }> => [
  { label: t('panel.cap'), value: 'cap' },
  { label: t('panel.flues'), value: 'flues' },
  { label: t('panel.shoulder'), value: 'shoulder' },
  { label: t('panel.bands'), value: 'bands' },
  { label: t('panel.cricket'), value: 'cricket' },
  { label: t('panel.panels'), value: 'panels' },
]
...
export default function ChimneyPanel() {
  ...
  return (
    ...
    >
      ...
      <PanelSection title={t('panel.footprint')}>
        <SegmentedControl
          onChange={(v) => handleUpdate({ bodyShape: v })}
          options={[
            { label: t('panel.square'), value: 'square' },
            { label: t('panel.round'), value: 'round' },
          ]}
      ...
      <PanelSection title={t('panel.chimneyType')}>
        <div className="grid grid-cols-2 gap-1.5 px-1 pt-1">
          {CHIMNEY_TYPE_OPTIONS(t)
            .filter((option) => {
        ...
        {chimneyType === 'cap' && (
          <>
            <SegmentedControl
              ...
              options={[
                { label: t('panel.none'), value: 'none' },
                { label: t('panel.sloped'), value: 'sloped' },
                { label: t('panel.flat'), value: 'flat' },
                { label: t('panel.stepped'), value: 'stepped' },
              ]}
        ...
        {chimneyType === 'shoulder' && (
          <>
            <SegmentedControl
              ...
              options={[
                { label: t('panel.none'), value: 'none' },
                { label: t('panel.tapered'), value: 'tapered' },
                { label: t('panel.corbeled'), value: 'corbeled' },
              ]}
        ...
        {chimneyType === 'bands' && (
          <>
            <SegmentedControl
              ...
              options={[
                { label: t('panel.none'), value: 'none' },
                { label: t('panel.single'), value: 'single' },
                { label: t('panel.double'), value: 'double' },
              ]}
        ...
        {chimneyType === 'cricket' && (
          <>
            <SegmentedControl
              ...
              options={[
                { label: t('panel.none'), value: 'none' },
                { label: t('panel.simple'), value: 'simple' },
              ]}
            ...
            {(node.cricketStyle ?? 'none') !== 'none' && (
              <>
                <SegmentedControl
                  ...
                  options={[
                    { label: t('panel.front'), value: 'front' },
                    { label: t('panel.back'), value: 'back' },
                  ]}
        ...
        {chimneyType === 'panels' && (
          <>
            <SegmentedControl
              ...
              options={[
                { label: t('panel.none'), value: 'none' },
                { label: t('panel.rectangular'), value: 'rectangular' },
              ]}
