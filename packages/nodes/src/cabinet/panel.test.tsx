...
test('renders the draft stepper, hanger toggle, and Apply/Cancel controls', () => {
  ...
  expect(markup).toContain('Shelf count')
  expect(markup).toContain('Increase shelf count')
  expect(markup).toContain('Decrease shelf count')
  expect(markup).toContain('Hanger rod')
  expect(markup).toContain('"aria-pressed":true')
  expect(markup).toContain('Cancel')
  expect(markup).toContain('Apply')
  expect(markup).toContain('Enter to apply')
...
test('renders the front kind selector and the sub-options for the active kind only', () => {
  ...
  expect(markup).toContain('Drawer count')
  expect(markup).toContain('Increase drawer count')
  expect(markup).toContain('Decrease drawer count')
  expect(markup).not.toContain('Leaves')
