...
export const aiChatDictionary = {
  ...
  'aiChat.op.splitBodyFace': { ko: '면 분할', en: 'Face split' },
  'aiChat.op.transformBody': { ko: 'Body 변환', en: 'Body transform' },
  'aiChat.op.arrayBodyLinear': { ko: 'Body 선형 배열', en: 'Body linear array' },
  'aiChat.op.arrayBodyCircular': { ko: 'Body 원형 배열', en: 'Body circular array' },
  'aiChat.op.intersectBodies': { ko: 'Body 교차', en: 'Body intersection' },
  'aiChat.op.unionBodies': { ko: 'Body 합치기', en: 'Body union' },
  'aiChat.op.subtractBodies': { ko: 'Body 빼기', en: 'Body subtraction' },
  'aiChat.op.outerShellBodies': { ko: 'Body 외부 셸', en: 'Body Outer Shell' },
  'aiChat.op.trimBodies': { ko: 'Body 트림', en: 'Body trim' },
  'aiChat.op.splitBodies': { ko: 'Body 분할', en: 'Body split' },
  'aiChat.op.groupBodies': { ko: 'Body 그룹', en: 'Body group' },
  'aiChat.op.createComponent': { ko: '컴포넌트 생성', en: 'Create component' },
  'aiChat.op.makeComponentUnique': { ko: '컴포넌트 고유화', en: 'Make component unique' },
  'aiChat.op.explodeComponent': { ko: '컴포넌트 분해', en: 'Explode component' },
